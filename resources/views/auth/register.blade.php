            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            <label for="adresse" class="col-md-4 col-form-label text-md-end">{{ __('Address') }}</label>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <select id="user_type" class="form-control @error('user_type') is-invalid @enderror" name="user_type" required>
                                    <option value="0" {{ old('user_type') == '0' ? 'selected' : '' }}>Artisan</option>
                                    <option value="1" {{ old('user_type') == '1' ? 'selected' : '' }}>Livreur</option>
