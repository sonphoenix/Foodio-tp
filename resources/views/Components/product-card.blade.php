...
<div class="relative m-4 flex-none w-full max-w-xs sm:w-1/2 md:w-1/3 lg:w-1/4 xl:w-1/4 flex-col overflow-hidden rounded-lg border border-gray-100 bg-white shadow-md">
    ...
    <div class="mt-4 px-5 pb-5 rounded-b-xl">
        ...
        <a href="{{ route('products.edit', $id) }}" class="flex items-center justify-center rounded-md bg-slate-900 px-5 py-2.5 text-center text-sm font-medium text-white hover:bg-gray-700 focus:outline-none focus:ring-4 focus:ring-blue-300">
