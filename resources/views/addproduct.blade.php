            ...
            <div class="border p-4">
                ...
                <form method="POST" enctype="multipart/form-data" action="{{ route('products.store') }}">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="w-full px-3 py-2 border rounded-md" id="productName" name="productName" required>
                    </div>
                    <div class="mb-3">
                        <label for="productPrice" class="form-label">Product Price</label>
                        <input type="number" class="w-full px-3 py-2 border rounded-md" id="productPrice" name="productPrice" required>
                    </div>
                    <div class="mb-3">
                        <label for="productDescription" class="form-label">Product Description</label>
                        <textarea class="w-full px-3 py-2 border rounded-md" id="productDescription" name="productDescription" rows="3" required></textarea>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="w-full px-3 py-2 border rounded-md" id="productStorage" name="productStorage" required>
                    </div>
                    <div class="mb-3">
                        <label for="minPieces" class="form-label">Minimum Pieces</label>
                        <input type="number" class="w-full px-3 py-2 border rounded-md" id="minPieces" name="minPieces" required>
                    </div>
...
<script>
    // Toggle visibility of subcategory name input based on dropdown selection
    document.getElementById('productSubcategory').addEventListener('change', function () {
        ...
        const otherSubcategoryOption = document.getElementById('otherSubcategoryOption');
